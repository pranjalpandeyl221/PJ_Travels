...
|-------------------------|-----------------------|
| ![Skeleton loading](screenshots/skeleton%20loadig%20screen%20for%20ui%20ux.png) | ![Clarification](screenshots/clarifying%20info%20about%20trip%20before%20planning.png) |
...
|---------------|--------------------|
| ![Overview](screenshots/overview.png) | ![Itinerary](screenshots/iternery-daywise%20plan.png) |
...
|---------------|-------------------|
| ![Q&A](screenshots/qna-with%20plan.png) | ![Replan](screenshots/replan-%20if%20budget%20exceeds%20trip%20cost.png) |
| *Conversational AI* — Ask questions about your plan | *Smart Budgeting* — One-click replan when over budget |

### Export & Sharing
| Download & Share Options |
|--------------------------|
| ![Export](screenshots/downloading%20and%20shring%20plan%20%2C%20over%20whatsapp%20or%20email.png) |
...
│   │   │   ├── AgentsContent.tsx      # Agent execution trace viewer
│   │   │   ├── BudgetContent.tsx      # Budget breakdown + warnings
│   │   │   ├── ChatMessage.tsx        # Chat bubble with markdown
│   │   │   ├── ChatPanel.tsx          # Main chat interface
│   │   │   ├── Dashboard.tsx          # Main tabbed interface
│   │   │   ├── HeroSection.tsx        # Landing page hero
│   │   │   ├── ItineraryContent.tsx   # Day-by-day itinerary display
│   │   │   ├── MarkdownText.tsx       # Markdown renderer
│   │   │   ├── NavBar.tsx             # Top navigation bar
│   │   │   ├── OverviewContent.tsx    # Trip overview with loading states
│   │   │   ├── SidePanel.tsx          # Settings and history drawer
│   │   │   ├── TipsContent.tsx        # Travel tips display
│   │   │   └── WorkflowBanner.tsx     # Agent progress indicator
│   │   ├── hooks/               # Custom React hooks
│   │   │   └── useTravelPlanner.ts    # SSE handling and state management
│   │   ├── utils/               # Utility functions
│   │   │   └── exportPlan.ts        # HTML/TXT generation and sharing
...
├── tests/                     # Test suite
│   ├── test_budget_fallback.py      # Edge case: zero budget handling
│   ├── test_followup_flows.py       # Streaming, chat, modification, over-budget
│   ├── test_json_utils.py           # JSON extraction accuracy
│   └── test_planner_api.py          # End-to-end API testing
